print("[LuaBuildEvents] Starting RemoteGitDeploy PostBuild\n")
require("lua.io")
...
pluginsPath = Path.combine(args[3], [[HtcSharp/plugins/RemoteGitDeploy]])
...
print("[LuaBuildEvents] Finishing RemoteGitDeploy PostBuild\n")